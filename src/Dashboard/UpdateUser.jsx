...
function UpdateUser() {
  ...
  const churchDetails = {
    ...
    const sendUpdate = () =>{
    Axios.post("http://localhost:3001/user_update",{
        name: name,
        week: week,
        amount: amount,
...
<div className='container'>
    <h3 className='container fw-bold text-uppercase ' style={{color:"navy" }}>Tithe</h3>
    <hr />
    </div>
    <br />

    <div className="container shadow-lg  mb-5 bg-body rounded flip-card">
    <div class=" container-fluid row g-3 needs-validation " novalidate>
          ...
          <div class="col-12 mb-5 ">
            <button class="btn me-5 mb-1  "  style={{backgroundColor:"orange",color:"white"}} onClick={sendUpdate} ><FaUserPlus /> Update User</button>
           <a href="/message"> <button class="btn me-5 mb-1  " style={{backgroundColor:"navy",color:"white"}}  ><FaRegCommentDots /> Send Message</button></a>
            <a href="/new_user"><button class="btn  me-5  mb-1" type="submit" style={{backgroundColor:"green",color:"white"}}><FaPlus /> Add User</button></a>
            <a href="delete_user"><button class="btn  me-5  mb-1" type="submit" style={{backgroundColor:"red",color:"white"}}><FaRegTrashAlt /> Delete User</button></a>
            <a href="/Afrancho_offering" className='text-decoration-none fw-bold float-end'>Offering <FaArrowRight /></a>
          </div>
 </div>
    </div>
